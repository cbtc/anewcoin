...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Sea
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Sea
    // Mac: ~/Library/Application Support/Sea
    // Unix: ~/.Sea
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Sea";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Sea.conf"));
